<html lang="en">
    ...
    <script src="../scripts/grafico4090.js" defer></script>
...
<body>
  <!--Cabeçalho da página com a logo, icone de voltar e icone para retornar a tela principal-->
    ...
    <!--Nome do trem-->
    <span id="nomeCircular">LINHA 4090</span>
    ...
    <section class="secaoRelatorio">
        ...
        <div id="centralizandoItens">
            ...
            <div id="reparticaoInfoRelatorio">
                ...
                <div id="centralizandoItens">
                    <span id="textoInfoRelatorio"><strong>30KM</strong></span>
            ...
            <div id="reparticaoInfoRelatorio">
                ...
                <div id="centralizandoItens">
                    <span id="textoInfoRelatorio"><strong>1h 50min</strong></span>
        ...
        <div id="centralizandoItens">
            ...
            <div id="reparticaoInfoRelatorio">
                ...
                <div id="centralizandoInfos">
                    ...
                    <span id="textoInfoRelatorio"><strong>14</strong>
                        <p>estações</p>
                    </span>
            ...
            <div id="reparticaoInfoRelatorio">
                ...
                <div id="centralizandoItens">
                    <span id="textoInfoRelatorio"><strong>60 km/h</strong></span>
        ...
        <div class="infosRelatorioLinha">
            <!--Ponto de Partida-->
            <div>
                <span id="subTexto3"><strong>Ponto de Partida: </strong>  Bucarein</span>
            </div>
            ...
            <div>
                <span id="subTexto3"><strong>Regiões onde ele Passa:</strong> Bucarein, Centro, Costa e Silva,
            Glória, Saguaçu, Santo Antônio.</span>
            </div>

            <!--Capacidade Máxima de Transporte-->
            <div>
                <span id="subTexto3"><strong>Capacidade Máxima de Transporte: </strong>5 toneladas.</span>
            </div>
        </div>
    </main>
    </section>
