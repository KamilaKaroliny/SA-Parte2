...
<head>
    ...
    <script src="../scripts/grafico1976.js" defer></script>
</head>
<body>
    ...
    <!--Nome do trem-->
    <span id="nomeCircular">LINHA 1976</span>
    ...
    <section class="secaoRelatorio">
        ...
        <div id="centralizandoItens">
            ...
            <div id="reparticaoInfoRelatorio">
                ...
                <div id="centralizandoItens">
                    <span id="textoInfoRelatorio"><strong>46KM</strong></span>
            ...
            <div id="reparticaoInfoRelatorio">
                ...
                <div id="centralizandoItens">
                    <span id="textoInfoRelatorio"><strong>56 min</strong></span>
        ...
        <div id="centralizandoItens">
            ...
            <div id="reparticaoInfoRelatorio">
                ...
                <div id="centralizandoInfos">
                    <span id="textoInfoRelatorio"><strong>5</strong>
                        <p>vagões</p>
                    </span>
            ...
            <div id="reparticaoInfoRelatorio">
                ...
                <div id="centralizandoItens">
                    <span id="textoInfoRelatorio"><strong>65 km/h</strong></span>
        ...
        <div class="tempoMedioBloco">
            ...
            <span id="subTexto2">14:20</span> <span id="texto3">Horário mais utilizado</span>
        </div>
        ...
        <div class="infosRelatorioLinha">
            ...
            <div>
                <span id="subTexto3"><strong>Regiões onde ele Passa:</strong> Dona Francisca, Jardim Paraíso,
            Jardim Sofia, Rio Bonito, Zona Industrial Norte. .</span>
            </div>

            <!--Capacidade Máxima de Transporte-->
            <div>
                <span id="subTexto3"><strong>Capacidade Máxima de Transporte: </strong> 500 pessoas.</span>
            </div>
        </div>
    </main>
    </section>
