...
<body>
    ...
    <div id="flex-container">
        ...
        <a href="telaInformacoesGilsemara.html">
            <img id="josevaldo" src="../assets/images/gilsemara.png" alt="Foto Josevaldo">
        </a>
        <a href="telaInformacoesGilsemara.html">
            <span id="nome1">GILSEMARA</span>
        </a>
    </div>
