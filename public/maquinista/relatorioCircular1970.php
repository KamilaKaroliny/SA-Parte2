...
<head>
    ...
    <script src="../scripts/graficoCircular1970.js" defer></script>
</head>
...
<body>
    ...
    <!--Nome do trem-->
    <span id="nomeCircular">LINHA 1970</span>
    ...
    <section class="secaoRelatorio">
        ...
        <div id="centralizandoItens">
            ...
            <div id="reparticaoInfoRelatorio">
                ...
                <div id="centralizandoItens">
                    <span id="textoInfoRelatorio"><strong>24KM</strong></span>
            ...
            <div id="reparticaoInfoRelatorio">
                ...
                <div id="centralizandoItens">
                    <span id="textoInfoRelatorio"><strong>26 min</strong></span>
        ...
        <div class="tempoMedioBloco">
            ...
            <span id="subTexto2">18:00</span> <span id="texto3">Horário mais utilizado</span>
        </div>
        ...
        <div class="infosRelatorioLinha">
            <!--Ponto de Partida-->
            <div>
                <span id="subTexto3"><strong>Ponto de Partida: </strong> Jardim Sofia</span>
            </div>
            
            <!--Destino Final-->
            <div>
                <span id="subTexto3"><strong>Destino Final: </strong>Bucarein</span>
            </div>
            
            <!--Regiões onde ele Passa-->
            <div>
                <span id="subTexto3"><strong>Regiões onde ele Passa:</strong>Jardim sofia, Iririú, Boa Vista,
                    Bucarein.</span>
            </div>
