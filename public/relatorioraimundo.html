...
<head>
    ...
    <script src="../scripts/graficoRaimundo.js" defer></script>
</head>
<body>
    ...
    <div id="flex10">
        <img id="foto" src="../assets/images/raimundo.png" alt="Imagem Raimundo">
        <div class="dados">
            <span><strong>Nome:</strong> Raimundo Gonçalves</span><br>
            <span><strong>Telefone:</strong>  +55 (21) 99546-7823</span><br>
            <span><strong>Idade:</strong> 38 anos</span><br>
            <span><strong>ID:</strong> LAK954ABSYX6</span><br>
            <span><strong>Tipo:</strong> Turismo</span>
        </div>
    </div>
    ...
    <section class="secaoRelatorio">
        ...
        <div class="linhaRelatorio">
            ...
            <div>
                ...
                <span id="subTexto3">●Sem Advertências</span>
            </div>
            <div>
                <span id="subTexto3"><strong>Tempo de empresa: </strong> 11 meses e 7 dias.</span>
            </div>
            <div>
                <span id="subTexto3"><strong>Quantidades de viagens: </strong> 8.456 viagens.</span>
            </div>
        </div>    
    </section>
