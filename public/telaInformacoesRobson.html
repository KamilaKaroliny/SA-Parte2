...
<head>
    ...
    <title>Tela de Informações Robson</title>
</head>

<body>
    <!-- Parte de cima do Informações Robson (flecha, casa e logo) -->
    <div id="flex7">
    ...
    <main>
        <div>
            <br>
            <br>
            <img src="../assets/images/robson.png">
            <h3>ROBSON OLIVEIRA DA COSTA</h3>
        </div>
        ...
        <div class="dados">
            ...
            <span><strong>ID: </strong>K4L8M2N6P5</span>
        </div>
