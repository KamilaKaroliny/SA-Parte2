...
<head>
    ...
    <script src="../scripts/grafico310.js" defer></script>
</head>
<body>
 <!--Cabeçalho da página com a logo, icone de voltar e icone para retornar a tela principal-->
    ...
    <!--Nome do trem-->
    <span id="nomeCircular">LINHA 310</span>
    ...
    <section class="secaoRelatorio">
        ...
        <div id="centralizandoItens">
            ...
            <div id="reparticaoInfoRelatorio">
                ...
                <div id="centralizandoItens">
                    <span id="textoInfoRelatorio"><strong>65KM</strong></span>
            ...
            <div id="reparticaoInfoRelatorio">
                ...
                <div id="centralizandoItens">
                    <span id="textoInfoRelatorio"><strong>1h e 6 min</strong></span>
        ...
        <div id="centralizandoItens">
            ...
            <div id="reparticaoInfoRelatorio">
                ...
                <div id="centralizandoInfos">
                    ...
                    <span id="textoInfoRelatorio"><strong>12</strong>
                        <p>estações</p>
                    </span>
            ...
            <div id="reparticaoInfoRelatorio">
                ...
                <div id="centralizandoItens">
                    <span id="textoInfoRelatorio"><strong>70 km/h</strong></span>
        ...
        <div class="tempoMedioBloco">
            ...
            <span id="subTexto2">17:30</span> <span id="texto3">Horário mais utilizado</span>
        </div>
        ...
        <div class="infosRelatorioLinha">
            <!--Ponto de Partida-->
            <div>
                <span id="subTexto3"><strong>Ponto de Partida: </strong> América</span>
            </div>
            
            <!--Destino Final-->
            <div>
                <span id="subTexto3"><strong>Destino Final: </strong>Santo Antônio</span>
            </div>
            
            <!--Regiões onde ele Passa-->
            <div>
                <span id="subTexto3"><strong>Regiões onde ele Passa:</strong>América, Anita Garibaldi,
            Atiradores, Bom Retiro, Bucarein, Centro, Costa e Silva, Glória, Saguaçu, Santo Antônio</span>
            </div>

            <!--Capacidade Máxima de Transporte-->
            <div>
                <span id="subTexto3"><strong>Capacidade Máxima de Transporte: </strong> 300 pessoas.</span>
            </div>
        </div>
    </main>
    </section>