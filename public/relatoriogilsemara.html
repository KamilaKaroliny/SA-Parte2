...
<head>
   ...
   <link rel="stylesheet" href="../style/style.css">
    ...
    <script src="../scripts/graficoGilsemara.js" defer></script>
...
<body>
    ...
    <div id="flex10">
        <img id="foto" src="../assets/images/gilsemara.png" alt="Imagem Gilsemara">
        <div class="dados">
            <span><strong>Nome:</strong> Gilsemara Schmidt</span><br>
    ...
    <section class="secaoRelatorio">
        ...
        <div class="linhaRelatorio">
            ...
            <div>
                ...
                <span id="subTexto3">● Estacionamento em Local Proibido</span>
            </div>
            <div>
                <span id="subTexto3"><strong>Tempo de empresa: </strong>  7 anos, 1 meses e 19 dias.</span>
            </div>
            <div>
                <span id="subTexto3"><strong>Quantidades de viagens: </strong> 14.895 viagens.</span>
            </div>
        </div>
    </section>   
