...
<head>
    ...
    <script src="../scripts/grafico290.js" defer></script>
</head>
<body>
    ...
    <!--Nome do trem-->
    <span id="nomeCircular">LINHA 290</span>
    ...
    <section class="secaoRelatorio">
        ...
        <div id="centralizandoItens">
            ...
            <div id="reparticaoInfoRelatorio">
                ...
                <div id="centralizandoItens">
                    <span id="textoInfoRelatorio"><strong>35KM</strong></span>
            ...
            <div id="reparticaoInfoRelatorio">
                ...
                <div id="centralizandoItens">
                    <span id="textoInfoRelatorio"><strong>45 min</strong></span>
        ...
        <div id="centralizandoItens">
            ...
            <div id="reparticaoInfoRelatorio">
                ...
                <div id="centralizandoItens">
                    <span id="textoInfoRelatorio"><strong>63 km/h</strong></span>
        ...
        <div class="tempoMedioBloco">
            ...
            <span id="subTexto2">07:00</span> <span id="texto3">Horário mais utilizado</span>
        </div>
        ...
        <div class="infosRelatorioLinha">
            <!--Ponto de Partida-->
            <div>
                <span id="subTexto3"><strong>Ponto de Partida: </strong> Aventureiro</span>
            </div>
            
            <!--Destino Final-->
            <div>
                <span id="subTexto3"><strong>Destino Final: </strong>Comasa</span>
            </div>
            
            <!--Regiões onde ele Passa-->
            <div>
                <span id="subTexto3"><strong>Regiões onde ele Passa:</strong>Aventureiro, Jardim Iririú, Iririú,
            Vila Nova, Comasa</span>
            </div>

            <!--Capacidade Máxima de Transporte-->
            <div>
                <span id="subTexto3"><strong>Capacidade Máxima de Transporte: </strong> 400 pessoas.</span>
            </div>
        </div>
    </main>
    </section>