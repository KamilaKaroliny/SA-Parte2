...
<head>
    ...
    <title>Tela de Informações Gilsemara</title>
</head>

<body>
    <!-- Parte de cima do Informações Gilsemara (flecha, casa e logo) -->
    <div id="flex7">
    ...
    <main>
        <div>
            <br>
            <br>
            <img src="../assets/images/gilsemara.png">
            <h3>GILSEMARA SCHMIDT</h3>
        </div>
        ...
        <div class="dados">
            ...
            <span><strong>ID: </strong>V6W5X2Y3Z9</span>
        </div>
