...
// BUSCAR MESES DO ANO
$sql_meses = "SELECT * FROM relatorios_usuarios WHERE id_usuario = ? AND ano = ? ORDER BY mes ASC LIMIT ? OFFSET ?";
            ...
            <?php while ($mes = $result_meses->fetch_assoc()): ?>
                <div class="cartao">
                    ...
                    <div class="icones">
                        ...
                        <!-- LINK CORRIGIDO -->
                        <a href="READRelatorioMaquinista.php?id=<?php echo $id_usuario; ?>&ano=<?php echo $mes['ano']; ?>&mes=<?php echo $mes['mes']; ?>">
