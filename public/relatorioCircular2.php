...
<head>
    ...
    <script src="../scripts/graficoCircular2.js" defer></script>
</head>
<body> 
    ...
    <br>
    <!--Nome do trem-->
    <span id="nomeCircular">LINHAS 2</span>
    <br>
    <br>
      ...
      <!--Primeira linha de informações: Distância, tempo médio, tipo de combustível-->
        <div id="centralizandoItens">
            ...
            <div id="reparticaoInfoRelatorio">
                ...
                <div id="centralizandoItens">
                    <span id="textoInfoRelatorio"><strong>84KM</strong></span>
            ...
            <div id="reparticaoInfoRelatorio">
                ...
                <div id="centralizandoItens">
                    <span id="textoInfoRelatorio"><strong>20 min</strong></span>
   ...
   <!--Segunda linha de informações: Número de estações, Número de vagões, Velocidade média-->
        <div id="centralizandoItens">
            ...
            <div id="reparticaoInfoRelatorio">
                ...
                <div id="centralizandoInfos">
                    <span id="textoInfoRelatorio"><strong>7</strong>
                        <p>estações</p>
                    </span>
            ...
            <div id="reparticaoInfoRelatorio">
                ...
                <div id="centralizandoInfos">
                    <span id="textoInfoRelatorio"><strong>6</strong>
                        <p>vagões</p>
                    </span>
            ...
            <div id="reparticaoInfoRelatorio">
                ...
                <div id="centralizandoItens">
                    <span id="textoInfoRelatorio"><strong>53 km/h</strong></span>
      ...
      <!--Horário com mais trânsito-->
        <div class="tempoMedioBloco">
            ...
            <span id="subTexto2">22:40</span> <span id="texto3">Horário mais utilizado</span>
        </div>
     ...
     <!--Informações adicionais como: Ponto de partida, Destino Final, Regiões onde ele passa, Capacidade Máxima de transporte-->
        <div class="infosRelatorioLinha">
         <!--Ponto de Partida-->
            <div>
                <span id="subTexto3"><strong>Ponto de Partida: </strong> Dona Francisca</span>
            </div>
         <!--Destino Final-->
            <div>
                <span id="subTexto3"><strong>Destino Final: </strong>Aventureiro</span>
            </div>
         <!--Regiões onde ele Passa-->
            <div>
                <span id="subTexto3"><strong>Regiões onde ele Passa:</strong> Dona Francisca, Jardim Paraíso, Jardim Sofia, Rio Bonito, Zona Industrial Norte, Aventureiro</span>
            </div>
        
         <!--Capacidade Máxima de Transporte-->
            <div>
                <span id="subTexto3"><strong>Capacidade Máxima de Transporte: </strong> 600 pessoas.</span>
            </div>
        </div>
